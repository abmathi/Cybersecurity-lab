...
![installed windows 10](../assets/WS01%20setup/1-installing-windows-10-pro.png)
...
![static ip](../assets/WS01%20setup/2-set-static-ip.png)
...
![time sync](../assets/WS01%20setup/6-fixed-time-sync-issue-and-forced-group-policy-update.png)
