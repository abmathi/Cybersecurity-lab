...
![config sysmon](../assets/DC01%20setup/11-configuring-sysmon.png)

![ws sysmon config](../assets/WS01%20setup/3-configuring-sysmon.png)
...
![install sysmon](../assets/DC01%20setup/12-installing-sysmon.png)
...
![verify running](../assets/DC01%20setup/13-verify-running.png)
...
![installed on ws01](../assets/WS01%20setup/3-configuring-sysmon.png)

![install and verify](../assets/WS01%20setup/4-install-sysmon-and-verify-running.png)
...
![logging events](../assets/DC01%20setup/14-verify-events-are-being-logged.png)

![logging events](../assets/WS01%20setup/5-verify-events-are-logged.png)
